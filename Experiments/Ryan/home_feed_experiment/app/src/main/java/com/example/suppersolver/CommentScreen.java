...
public class CommentScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cmtEdtEdt = findViewById(R.id.comment_edt_edt);
        edtButton = findViewById(R.id.cmtEdit);
...
//                params.put("param2", "value2");
    ...
    private void putRequest(String curID) {
        ...
        JSONObject postBody = new JSONObject();
        try{
            String edtCmtText = cmtEdtEdt.getText().toString();  // Get the input text from EditText
            postBody.put("comment", edtCmtText);// Assuming the server expects a key "comment"
        } catch (Exception e){
            e.printStackTrace();
        }
