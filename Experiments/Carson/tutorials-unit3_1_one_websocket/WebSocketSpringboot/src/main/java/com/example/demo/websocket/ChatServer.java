 ...
 */
@ServerEndpoint("/carsonschat/{username}")
@Component
public class ChatServer {
    ...
    public void onOpen(Session session, @PathParam("username") String username) throws IOException {
        ...
        if (usernameSessionMap.containsKey(username)) {
            ...
            sendMessageToPArticularUser(username, "Welcome to carson's websocket! , "+username);
    ...
    public void onClose(Session session) throws IOException {
        ...
        broadcast(username + " disconnected from carson's websocket!");
    }
    ...
    private void sendMessageToPArticularUser(String username, String message) {
        try {
            ...
            logger.info("[DM Exception] Carsons DM!" + e.getMessage());
        }
    }
