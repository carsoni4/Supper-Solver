 ...
 */
public class CreateGroupAdapter extends BaseAdapter implements ListAdapter {
    ...
    private OnGroupListChangeListener listener;

    public CreateGroupAdapter(ArrayList<String> list, Context context, OnGroupListChangeListener listener) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.custom_layoutcreategroup, null);
        }
